    ...
    return (
        <div>
            <div className="p-6 container md:w-2/3 xl:w-auto pt-12 border-t-2 border-blue-200  flex flex-col xl:items-stretch justify-between xl:flex-row max-w-screen-xl mx-auto my-16">
                <div className="xl:w-1/2 md:mb-14 xl:mb-0 relative h-auto flex items-center justify-center" data-aos="fade-right" data-aos-duration="1000">
                ...
                <div className="w-full xl:w-1/2 xl:pl-40 xl:py-28 " data-aos="fade-left" data-aos-duration="1000">
